...
def main():
    ...
    pdf_lines_path = os.path.join(
        BASE_OUTPUT_PROCESSED_DIR, "pdf-to-parquet", "combined_documents_all_years.parquet"
    )
    outlines_path = os.path.join(
        BASE_OUTPUT_PROCESSED_DIR, "outlines", "merged_outlines.parquet"
    )
    outlines_with_position_in_content_path = os.path.join(
        BASE_OUTPUT_PROCESSED_DIR, "outlines", "merged_outlines_with_position_in_content.parquet"
                                            )
